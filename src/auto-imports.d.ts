...
declare global {
  ...
  const addAddress: typeof import('./utils/address')['addAddress']
  const addItem: typeof import('./utils/invoice')['addItem']
  ...
  const createInvoice: typeof import('./utils/invoice')['createInvoice']
  ...
  const exportAll: typeof import('./utils/invoice')['exportAll']
  ...
  const getFormData: typeof import('./utils/index')['getFormData']
  const handleFormData: typeof import('./utils/server')['handleFormData']
  const hasContext: typeof import('svelte')['hasContext']
  const importInvoices: typeof import('./utils/invoice')['importInvoices']
  ...
  const removeAddresses: typeof import('./utils/address')['removeAddresses']
  const removeInPlace: typeof import('./utils/index')['removeInPlace']
  const removeInvoice: typeof import('./utils/invoice')['removeInvoice']
  const removeItems: typeof import('./utils/invoice')['removeItems']
